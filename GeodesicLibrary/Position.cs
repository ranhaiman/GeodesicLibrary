...
namespace GeodesicLibrary
{
	public class Position
	{
		...
		{
			get => _latitude.Degrees;
			set => _latitude = Angle.FromDegrees(value);
		}
		...
		{
			get => _longitude.Degrees;
			set => _longitude = Angle.FromDegrees(value);
		}

		/// <summary>
		/// The mean radius of the Earth - 6371km.
		/// </summary>
		private readonly Length _radius = Length.FromKilometers(6371);
